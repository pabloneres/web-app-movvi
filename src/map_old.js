...
class MapUpdate extends React.Component {
  ...
  render() {
    ...
    return (
      <div style={{ width: "100%", height: "100%" }}>
        <div>
          <input ref="lat" type="text" value={this.state.form.lat} onChange={this.handleChange} />
          <input ref="lng" type="text" value={this.state.form.lng} onChange={this.handleChange} />
